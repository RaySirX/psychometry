...
# ------------- Drivers --------------------------
DriverVersion=os.popen("""LC_ALL=C lspci -v -s $(lspci | grep ' VGA ' | cut -d" " -f 1 | head -1) | grep driver """).read() 
...
# ------------- InstalledVram --------------------------
InstalledVram=os.popen("""LC_ALL=C dmesg | egrep 'drm|radeon' | grep Detected """).read() 
